...
class ScarStateManager : public rclcpp::Node {
 public:
                       ...
                       state_(State::IDLE)
  {
    ...
    spd_approach_ = declare_parameter("speed_approach_mps",  0.15);
    spd_climb_f_  = declare_parameter("speed_climb_f_mps",   0.25);
    spd_climb_r_  = declare_parameter("speed_climb_r_mps",   0.22);
    ...
    load_contact_ = (int16_t)declare_parameter("load_stair_contact", 500);
